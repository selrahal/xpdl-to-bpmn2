...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:albpm="http://www.albpm.com/2007/albpm.XPDL2" xmlns:xpdl2="http://www.wfmc.org/2009/XPDL2.2" xmlns:drools="http://www.jboss.org/drools" xmlns:bpmn2="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:color="http://www.omg.org/spec/BPMN/non-normative/color" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:di="http://www.omg.org/spec/DD/20100524/DI" xmlns:xpdExt="http://www.tibco.com/XPD/xpdExtension1.0.0" version="1.0">
  ...
  <xsl:template match="xpdl2:WorkflowProcesses">
    <xsl:apply-templates select="xpdl2:WorkflowProcess/xpdl2:Activities/xpdl2:Activity/xpdl2:Event/xpdl2:IntermediateEvent[@Trigger='Message']"/> 
  ...
  <xsl:template match="xpdl2:Activities">
    ...
    <xsl:apply-templates select="xpdl2:Activity[not(xpdl2:Implementation) and not(xpdl2:Event) and not(xpdl2:Route)]"/>
    ...
    <xsl:apply-templates select="xpdl2:Activity/xpdl2:Event/xpdl2:IntermediateEvent[@Trigger='Message']/xpdl2:TriggerResultMessage[@CatchThrow='THROW']"/>
