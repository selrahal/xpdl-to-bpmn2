...
public final class Validator {
     ...
     */
    public static Document loadDefinition(final File def) {
     ...
     */
    public static boolean validateDefinition(final Document def, final ProcessLanguage language) {
     ...
     * @return Whether the validation was successful.
     */
    public static boolean validateDefinition(final String def, final ProcessLanguage language) {
